...
class BolForm(ModelForm):
    ...
    exporterName = forms.CharField(required=False, label='Exporter Name', max_length=255)
    ...
    vessel = forms.CharField(required=False, label='Vessel', max_length=255)
    ...
    customSeat = forms.CharField(required=False, label='Custom Seat', max_length=255)
    ...
    class Meta:
        ...
        fields = '__all__'
        widgets = {
            'dateOfIssue': forms.DateInput(attrs={'type':'date'}),
